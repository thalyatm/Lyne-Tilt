...
const CATEGORY_ORDER = ['Shipping', 'Handmade Work', 'Colour Accuracy', 'Returns + Exchanges', 'Product Care', 'Coaching + Services'];
...
const DEFAULT_FAQS: FAQItem[] = [
  ...
  // HANDMADE WORK
  { id: 'hand-1', question: 'Are your pieces truly handmade?', answer: 'Each piece is handmade and may contain slight imperfections or variations. These are not flaws, but the marks of authentic craftsmanship.<br/><br/>I only list what I would proudly wear or collect myself.', category: 'Handmade Work', displayOrder: 1 },
  // COLOUR ACCURACY
  { id: 'colour-1', question: 'Will colours look exactly like the photos?', answer: 'Please note that colours may appear slightly different across devices and screens. I do my best to represent all pieces as accurately as possible.', category: 'Colour Accuracy', displayOrder: 1 },
  // RETURNS + EXCHANGES
